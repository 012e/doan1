...
#figure(image("images/2025-03-07-22-24-02.png"), caption: [Minh họa Multiple Instances per Host])
...
#figure(image("images/2025-03-07-22-22-49.png"), caption: [Kiến trúc Docker])
...
#align(center)[
  #figure(image("images/2025-03-07-22-29-48.png", width: 5cm), caption: [Logo Kubernetes])
]
...
#align(center)[
  #figure(image("images/2025-03-07-22-27-44.png", width: 5cm), caption: [Logo Helm])
]
...
#align(center)[
  #figure(image("images/2025-03-07-22-32-03.png", width: 5cm), caption: [Logo Consul])
]
...
#figure(image("images/2025-03-07-22-37-24.png"), caption: [Demo Grafana Dashboard])
...
#figure(image("images/2025-03-07-22-36-34.png"), caption: [Kiến trúc ELK Stack])
...
#figure(image("images/2025-03-07-22-34-57.png"), caption: [Kiến trúc OpenTelemetry])
...
#figure(image("images/2025-03-07-22-35-28.png"), caption: [Demo Jaeger UI])
